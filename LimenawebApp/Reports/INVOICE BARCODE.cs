...
namespace LimenawebApp.Reports {
    ...
    public class INVOICE_BARCODE : ReportClass {
        
        public INVOICE_BARCODE() {
        }
        
        public override string ResourceName {
            get {
                return "INVOICE BARCODE.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "LimenawebApp.Reports.INVOICE BARCODE.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedINVOICE_BARCODE : Component, ICachedReport {
        
        public CachedINVOICE_BARCODE() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            INVOICE_BARCODE rpt = new INVOICE_BARCODE();
            rpt.Site = this.Site;
            return rpt;
        }
